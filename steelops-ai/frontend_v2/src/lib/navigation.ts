...
export const PRIMARY_NAV: NavDefinition[] = [
  ...
  { href: "/eaf/validation", label: "Plant Validation", icon: CheckCircle2 },
  { href: "/eaf/reliability", label: "Reliability Dashboard", icon: BarChart3 },
  { href: "/eaf/feedback", label: "Operator Feedback", icon: MessageSquare },
  { href: "/eaf/deployment-readiness", label: "Deployment Readiness", icon: ShieldAlert },
  { href: "/eaf/whatif", label: "What-if Analysis", icon: Sparkles },
  { href: "/eaf/historical", label: "Historical Analysis", icon: Database },
